      ...
      <div className="max-w-3xl mx-auto">
        <ul className="list pl-6 space-y-6 text-center sm:text-lg">
          <li className='flex flex-col items-center'>
            <Image src="/man.png" alt="profile" width={200}
  height={200} / >
            <p className="font-semibold ">Mr. Shivam Pathak</p>
            <p className="text-indigo-700">Director</p>
            <a className="text-blue-600 font-semibold hover:underline" href="https://www.linkedin.com/in/Shivam Pathak" target="_blank" rel="noopener noreferrer">
              LinkedIn Profile
            </a>

          </li>
          <li className='flex flex-col items-center'>
            <Image src="/woman.png" alt="profile" width={200}
  height={200}/ >
