				...
				<Accordion className="ml-1 sm:ml-2 md:ml-3 lg:ml-4 mt-3 mr-4 sm:mr-5 md:mr-5 lg:mr-6">
					{questionqa100.map((item, index) => (
						<Accordion.Item key={index} value={item.question}>
							...
							<Accordion.Panel className="mt-3 text-base pl-1 sm:pl-2 md:pl-3 lg:pl-4 sm:text-base md:text-lg lg:text-lg leading-relaxed opacity-85 whitespace-pre-line">
								{item.type === "contact" ? (
									<>
										Visit{" "}
										<a
