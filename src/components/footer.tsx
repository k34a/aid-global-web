        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mt-6 pt-6 border-t border-gray-800 text-center">
            <p className="text-gray-500 text-xs leading-relaxed max-w-4xl mx-auto">
              {ngoDetails.name} is a registered non-profit organization
              dedicated to creating positive change in communities worldwide.
              Your donations are tax-deductible to the fullest extent allowed by
              law. We are committed to transparency and accountability in all
              our operations.
            </p>
          </div>
        </div>
