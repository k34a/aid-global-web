...
const AssuranceSection = () => {
	return (
		<section className="py-16 bg-white relative overflow-hidden">
			...
			<div className="absolute top-0 left-0 w-64 h-64 bg-sky-100 rounded-full blur-3xl opacity-40 -z-10 animate-pulse"></div>
			<div className="absolute bottom-0 right-0 w-64 h-64 bg-sky-200 rounded-full blur-2xl opacity-30 -z-10 animate-pulse"></div>
			...
			<div className="max-w-6xl mx-auto px-4">
				<h2 className="text-center text-3xl sm:text-4xl font-bold text-black mb-16 relative">
					<span className="inline-block relative">
						...
						, Our Priority
						<span className="absolute left-1/2 -bottom-1 w-24 h-1 bg-sky-500 rounded-full -translate-x-1/2" />
					</span>
				</h2>
						...
						return (
							...
							>
								<div className="w-14 h-14 mx-auto mb-4 bg-white border-2 border-black rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
									<Icon className="w-6 h-6 text-black group-hover:text-sky-600 transition duration-300" />
								</div>
