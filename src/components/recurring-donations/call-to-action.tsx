...
const CallToAction = () => {
	return (
		<div className="flex flex-col lg:flex-row bg-gradient-to-br from-[#2563eb] via-[#4ECDC4] to-blue-400 text-white rounded-xl p-6 lg:p-10 gap-6 lg:gap-10 max-w-6xl mx-auto my-10">
			{/* Left Section */}
