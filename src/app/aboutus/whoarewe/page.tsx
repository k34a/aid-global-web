...
function Whoarewe() {
	return (
		<div className="mt-4 lg:mt-20 font-[Times_New_Roman] bg-blue-50">
			<div className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl bg-[url('/background.webp')] bg-cover bg-center h-96 w-full flex flex-row justify-between">
				...
				<Image
					className="pr-4 sm:pr-6 md:pr-10 lg:pr-16 xl:pr-24"
					src="/who_are_we.webp"
			...
			<div className="text-lg sm:text-lg pl-4 sm:pl-6 md:pl-10 lg:pl-16 xl:pl-24">
				<h2 className="text-xl sm:text-2xl font-bold text-blue-500 mt-8 mb-2">
					About us
				</h2>
				...
				<ul className="list-disc space-y-2 pl-8 sm:pl-10 md:pl-12 lg:pl-16 xl:pl-24">
					<li>
						<strong>ShikshaAid</strong> – Access to education for
						underprivileged children
					</li>
					<li>
						<strong>EnableAid</strong> – Support and empowerment for
						differently-abled and disability elimination
					</li>
					<li>
						<strong>CureAid</strong> – Primary healthcare and
						wellness services
					</li>
					<li>
					...
					<li>
						<strong>GharAid</strong> – Safe and secure shelter for
						homeless and orphaned people
					</li>
					<li>
						<strong>SakhiAid</strong> – Women&apos;s empowerment and
						hygiene protection initiatives
					</li>
				</ul>
			</div>

			<div className="flex flex-col md:flex-row justify-between gap-6 px-4 sm:px-6 md:px-10 lg:px-16 xl:px-24 pt-4 sm:pt-6 md:pt-8 lg:pt-12 font-[Times_New_Roman]">
				<div
					className="relative flex-1 h-96 rounded-2xl overflow-hidden bg-cover bg-center shadow-md"
			...
			<div className="text-lg sm:text-lg pl-4 sm:pl-6 md:pl-10 lg:pl-16 xl:pl-24">
				<h2 className="text-xl sm:text-2xl font-bold text-blue-500 mt-8 mb-4">
					Core Values
				</h2>
