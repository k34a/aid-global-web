	...
	const questions = [
		{
			...
			answer: `Coins cannot be refunded, but they will always end up helping a project via your chosen category - so no rupee ever sits idle.`,
		},
		{
			question: "Can I transfer my coins to another user?",
			answer: `No - coins are tied to your wallet and cannot be transferred.`,
		},
		{
			question: "What if my coin purchase fails?",
			answer: `Ping us with your transaction ID and we will sort it out quickly. Missing coins will be credited ASAP.`,
		},
	];
